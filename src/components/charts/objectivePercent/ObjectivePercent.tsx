    ...
    return (
        <section className="ctnObjectivePercent">
            <ResponsiveContainer width="100%" height="100%">
                <PieChart >
                    <Pie labelLine={false} data={[dataChart]} style={{fontFamily:"Roboto"}} dataKey="value" cx="50%" cy="50%" paddingAngle={padding} innerRadius={75} outerRadius={90} fill="#FF0000" label={false} />
                    
                    <Pie labelLine={false} data={[{value:360, name:""}]} dataKey="value" cx="50%" cy="50%" innerRadius={0} outerRadius={75} fill="white" label={false} />
